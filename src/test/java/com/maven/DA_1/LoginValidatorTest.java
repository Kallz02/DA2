...
public class LoginValidatorTest {
    ...
    public void testValidCredentials() {
        ...
        System.out.println(
                "[TEST CASE 1]: Testing with the correct username and password !!");

        boolean result = loginValidator.validateCredentials("AK", "20MIC0023");
    ...
    public void testInvalidCredentials() {
        ...
        System.out.println(
                "[TEST CASE 2]: Testing with an incorrect username and password combination !!");
